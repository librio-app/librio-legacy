...
class ThemesExport implements FromQuery, WithHeadings
{
    /**
     * @var Builder
     */
    ...
    public function query()
    {
        $query = $this->query
          ...
          ->join('books', 'books.id', '=', 'theme_book.book_id')
        ...
        $route = \Route::current();
        if ($route->hasParameter('theme')) {
            $query->where('themes.id', '=', $route->parameter('theme'));
        }
