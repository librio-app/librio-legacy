...
class FormServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Form::component('selectGroup', 'partials.form.select_group', [
            'name', 'text', 'icon', 'values', 'selected' => null, 'attributes' => ['required' => 'required', 'add' => false], 'col' => 'col-md-6',
        ]);
        ...
        Form::component('radioGroup', 'partials.form.radio_group', [
            'name', 'text', 'checked' => false, 'enable' => trans('general.yes'), 'disable' => trans('general.no'), 'attributes' => [], 'col' => 'col-md-6',
        ]);
        ...
        Form::component('dateRange', 'partials.form.date_range', [
            'name', 'text', 'icon', 'attributes' => ['autocomplete' => 'off'], 'value' => null, 'col' => 'col-md-6',
        ]);
    }
