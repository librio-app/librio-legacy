...
class Installer
{
    ...
    public static function createDbTables($host, $port, $database, $username, $password)
    {
        ...
        // Create Roles
        Artisan::call('db:seed', ['--class' => Roles::class, '--force' => true]);
    ...
    public static function createCompanyName($name)
    {
        // Update .env file
        static::updateEnv([
            'APP_NAME' => "'$name'",
    ...
    public static function createUser($email, $name, $password, $locale)
    {
        // Create the user
        $user = User::create([
            'name' => $name,
