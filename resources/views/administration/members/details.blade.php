                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group no-margin">
                                <a href="{{ route('members.activate', ['member' => $member]) }}" class="btn btn-success pull-right" style="margin-left: 5px"><span class="fa fa-mail-forward"></span> &nbsp;{{ trans('general.send_activation_mail') }}</a>
                            </div>
