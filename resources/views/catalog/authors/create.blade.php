...
@section('title', trans('general.title.new', ['type' => trans_choice('general.authors', 1)]))
@section('header', trans('general.title.new', ['type' => trans_choice('general.authors', 1)]))
@section('breadcrumb')
...
@section('content')
    ...
    <div class="box box-primary">
        {!! Form::open(['url' => 'catalog/authors', 'role' => 'form']) !!}

        <div class="box-body">
            {{ Form::textGroup('first_name', trans('general.first_name'), 'bookmark', ['autofocus' => true]) }}
        ...
        <div class="box-footer">
            {{ Form::saveButtons('catalog/authors') }}
        </div>
