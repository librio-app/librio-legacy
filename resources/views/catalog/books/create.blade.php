...
@section('title', trans('general.title.new', ['type' => trans_choice('general.books', 1)]))
@section('header', trans('general.title.new', ['type' => trans_choice('general.books', 1)]))
@section('breadcrumb')
...
@section('content')
    ...
    <div class="box box-primary">
        {!! Form::open(['url' => 'catalog/books', 'role' => 'form']) !!}

        <div class="box-body">
            {{ Form::textGroup('title', trans('general.title.default'), 'bookmark', ['autofocus' => true]) }}
            ...
            {{ Form::selectGroup('themes', trans_choice('general.themes', 2), 'eyedropper', $themes, null, ['add' => true, 'multiple' => 'multiple']) }}
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var nameElement = $("input[name='title']");
