...
@section('title', trans('general.title.edit', ['type' => trans_choice('general.publishers', 1)]))
@section('header', trans('general.title.edit', ['type' => trans_choice('general.publishers', 1)]))
@section('breadcrumb')
...
@section('content')
    ...
    <div class="box box-primary">
        {!! Form::model($publisher, [
            'method' => 'PATCH',
            'url' => ['catalog/publishers', $publisher->id],
            'role' => 'form',
        ]) !!}
