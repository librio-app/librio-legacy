...
@section('title', trans('general.title.new', ['type' => trans_choice('general.types', 1)]))
@section('header', trans('general.title.new', ['type' => trans_choice('general.types', 1)]))
@section('breadcrumb')
...
@section('content')
    ...
    <div class="box box-primary">
        {!! Form::open(['url' => 'catalog/types', 'role' => 'form']) !!}
