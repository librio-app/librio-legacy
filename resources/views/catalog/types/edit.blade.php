...
@section('title', trans('general.title.edit', ['type' => trans_choice('general.types', 1)]))
@section('header', trans('general.title.edit', ['type' => trans_choice('general.types', 1)]))
@section('breadcrumb')
...
@section('content')
    ...
    <div class="box box-primary">
        ...
        @permission('update-catalog-types')
        <div class="box-footer">
            {{ Form::saveButtons('catalog/types') }}
        </div>
        <!-- /.box-footer -->
        @endpermission
